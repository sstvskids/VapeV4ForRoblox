...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/sstvskids/VapeV4ForRoblox/main/NewMainScript.lua", true))()
```
...
<br/>
[7GrandDad](https://github.com/sstvskids) - Original creator of the project - vaperoblox on Discord
<br/>
