...
entitylib.isVulnerable = function(ent)
	return ent.Health > 0 and not (ent.Character.FindFirstChildWhichIsA(ent.Character, 'ForceField') and ent.Character.FindFirstChildWhichIsA(ent.Character, 'ForceField').Visible)
end
